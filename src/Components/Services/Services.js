        ...
        <>
            <section class="articles my-4">
                <article>
                    <div class="article-wrapper text-center">
                        <figure>
                            <img src="https://www.elexoft.com/assets/images/services/web-development.jpg" alt="" />
                        </figure>
                        <div class="article-body">
                            ...
                            <a href="/Web_Development" class="read-more">
                ...
                <article>
                    <div class="article-wrapper text-center">
                        <figure>
                            <img src="https://www.elexoft.com/assets/images/services/graphic-designing-min.jpg" alt="" />
                        </figure>
                        <div class="article-body">
                            ...
                            <a href="/Graphic_Design" class="read-more">
                                Read more <span class="sr-only">about this is some title</span>
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
                                </svg>
            ...
            <section class="articles my-4">
                ...
                <article>
                    ...
                    <div class="article-wrapper text-center">
                        <figure>
                            <img src="https://www.elexoft.com/assets/images/services/SEO-Optimization-Illustration-min.jpg" alt="" />
                        </figure>
                        <div class="article-body">
                            <h2>SEO</h2>
                            <p>
            ...
            <section class="articles my-4">
                <article>
                    <div class="article-wrapper text-center">
                        <figure>
                            <img src="https://www.elexoft.com/assets/images/services/iphone-app-development-min.jpg" alt="" />
                        </figure>
                        <div class="article-body">
                            <h2>IOS Apps</h2>
                            <p>
                ...
                <article>
                    ...
                    <div class="article-wrapper text-center">
                        <figure>
                            <img src="https://www.elexoft.com/assets/images/services/Android-app-development.jpg" alt="" />
                        </figure>
                        <div class="article-body">
                            <h2>Android Apps</h2>
                            <p>
                ...
                <article>
                    ...
                    <div class="article-wrapper text-center">
                        <figure>
                            <img src="https://www.elexoft.com/assets/images/services/aso.jpg" alt="" />
                        </figure>
                        <div class="article-body">
                            <h2>ASO</h2>
                            <p>
                                Most of the traffic comes from the first 3-5 positions in the SERP. Therefore, we increase the visibility of the application in the search results: we conduct text optimization taking into account the features of the store and their ranking algorithms. To increase the conversion to the installation, we work on the icon and screenshots to make the application more attractive to users.</p>
                            <a href="/" class="read-more">
                                Read more <span class="sr-only">about this is some title</span>
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
